...
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1001847401406')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", """<i><b>📁ғɪʟᴇ ɴᴀᴍᴇ</b></i>: <i><b>{file_name}</b></i>
 
<i><b>⚙️ғɪʟᴇ sɪᴢᴇ</b></i>:<i><b> {file_size}</b></i>""" )
