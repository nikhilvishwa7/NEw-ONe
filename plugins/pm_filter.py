...
InlineKeyboardButton("💠ʜᴏᴡ ᴛᴏ ᴠᴇʀɪғʏ💠",url="https://t.me/aboutme_tonystark/03")
            ...
            await client.send_message(
                chat_id=query.from_user.id,
                text="<b>💠Nᴏᴛᴇ :- ᴘʟᴇᴀsᴇ ᴠᴇʀɪғʏ ᴀɴᴅ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ғɪʟᴇ ᴀᴄᴄᴇs ᴜɴᴛɪʟ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴡʜɪᴄʜ ɪs ᴀғᴛᴇʀ 2 ʜᴏᴜʀs ғʀᴏᴍ ɴᴏᴡ⚡ «~» অনুগ্রহ করে ᴠᴇʀɪғʏ করুন এবং 2 ঘণ্টার জন্য সব ফাইল নিন বাধাহীন ভাবে⚡ «~» कृपया ᴠᴇʀɪғʏ करें और अगले ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ तक असीमित फ़ाइल एक्सेस प्राप्त करें जो अब से 2 घंटे बाद है⚡</b>",
