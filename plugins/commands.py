...
InlineKeyboardButton("💠ʜᴏᴡ ᴛᴏ ᴠᴇʀɪғʏ💠",url="https://t.me/aboutme_tonystark/03")
                ...
                await message.reply_text(
                    text="<b>💠Nᴏᴛᴇ :- ᴘʟᴇᴀsᴇ ᴠᴇʀɪғʏ ᴀɴᴅ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ғɪʟᴇ ᴀᴄᴄᴇs ᴜɴᴛɪʟ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴡʜɪᴄʜ ɪs ᴀғᴛᴇʀ 2 ʜᴏᴜʀs ғʀᴏᴍ ɴᴏᴡ⚡n\অনুগ্রহ করে ᴠᴇʀɪғʏ করুন এবং 2 ঘণ্টার জন্য সব ফাইল নিন বাধাহীন ভাবে⚡n\कृपया सत्यापित करें और अगले सत्यापन तक असीमित फ़ाइल एक्सेस प्राप्त करें जो अब से 2 घंटे बाद है⚡</b>",
                    protect_content=True,
                    reply_markup=InlineKeyboardMarkup(btn)
                )
                return
...
InlineKeyboardButton("💠ʜᴏᴡ ᴛᴏ ᴠᴇʀɪғʏ💠",url="https://t.me/aboutme_tonystark/03")
        ...
        await message.reply_text(
            text="<b>💠Nᴏᴛᴇ :- ᴘʟᴇᴀsᴇ ᴠᴇʀɪғʏ ᴀɴᴅ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ғɪʟᴇ ᴀᴄᴄᴇs ᴜɴᴛɪʟ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴡʜɪᴄʜ ɪs ᴀғᴛᴇʀ 2 ʜᴏᴜʀs ғʀᴏᴍ ɴᴏᴡ⚡n\অনুগ্রহ করে ᴠᴇʀɪғʏ করুন এবং 2 ঘণ্টার জন্য সব ফাইল নিন বাধাহীন ভাবে⚡n\कृपया सत्यापित करें और अगले सत्यापन तक असीमित फ़ाइल एक्सेस प्राप्त करें जो अब से 2 घंटे बाद है⚡
</b>",
            protect_content=True,
            reply_markup=InlineKeyboardMarkup(btn)
        )
